...
<body>
    <nav id="" class="navbar navbar-expand-md navbar-dark bg-dark fixed-top d-md-none d-sm-block d-lg-none">
        <div class="container">
    ...
    <nav id="nav" class="navbar navbar-expand-md p-r navbar-dark bg-dark rounded-pill position-relative shadow d-none d-md-block d-sm-none d-lg-block mx-4">
        <div class="container ">
            <a class="img-fluid" href=""><img src="assets/img/logo/logowonderful.webp" width="120px" alt=""></a>
            <a href="" class=" text-decoration-none ms-auto d-flex d-xs-block d-sm-block d-md-none d-lg-none"><i class='bx bx-user-circle text-white opacity-50 bx-sm  '></i></a>
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar">
